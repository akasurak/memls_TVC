...
text(x(2),yh(length(yh)-1),['T ground: ',num2str(Tgnd),'K;  snow-ground reflectivity (h/v): ',num2str(s0h),'/',num2str(s0v)])
hold off
...
title(['snow layer model - inputdata: ',ifile])
%gtext(['T ground: ',num2str(Tgnd),'K;  snow-ground reflectivity (h/v): ',num2str(s0h),'/',num2str(s0v)])
text(x(2),yeh(length(yeh)-1),['T ground: ',num2str(Tgnd),'K;  snow-ground reflectivity (h/v): ',num2str(s0h),'/',num2str(s0v)])
hold off
